...
export default class MoviePage extends Component {
  ...
  componentDidMount() {
    ...
    const movieUri =
      ...
      "?api_key=1a60a9483b15c60fdebc9600bc1e67af&language=en-US";
    ...
    return (
      <div className="moviePage">
        ...
        <div className="moviePageContent">
          ...
          <p className="moviePageOverview">{this.state.movie.overview}</p>
          ...
          <div>
            <a
              href={"http://www.imdb.com/title/" + this.state.movie.imdb_id}
              class="moviePageIconLink"
            >
              <img src={imdb} class="moviePageIcon" />
            </a>
          </div>
        </div>
      </div>
